...
def add_md(source):
    notebook["cells"].append({"cell_type": "markdown", "id": os.urandom(4).hex(), "metadata": {}, "source": source})

def add_code(source):
    notebook["cells"].append({"cell_type": "code", "execution_count": None, "id": os.urandom(4).hex(), "metadata": {}, "outputs": [], "source": source})
...
add_md(["## A.4 — Tokenization & Dataset Class"])
add_code([
    "import torch\n",
    "import json\n",
    "import pickle\n",
...
add_md(["## A.6 — Training Configuration"])
add_code([
...
add_md(["## A.8 — Evaluation on Test Set"])
add_code([
...
with open("c:/Users/Mamatha/Desktop/Projects/icd-insight/notebooks/01_QLoRA_Training.ipynb", "w", encoding="utf-8") as f:
    json.dump(notebook, f, indent=1)

print("Saved Notebook A successfully.")
